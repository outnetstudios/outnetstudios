...
if (empty($config['db']['host'])) {
    die("❌ DB_HOST no configurado. Revisa las env vars en Wasmer.");
}
...
try {
    ...
    $pdo->exec("
        CREATE TABLE IF NOT EXISTS catalog_password_resets (
            id INT AUTO_INCREMENT PRIMARY KEY,
            user_id INT NOT NULL,
            token VARCHAR(128) NOT NULL UNIQUE,
            expires_at DATETIME NOT NULL,
    ...
    echo "✅ Todas las tablas creadas en la base de datos '{$db['dbname']}'.";
